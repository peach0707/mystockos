...
import {holdingQuoteNotice} from './quote-status.js';

const unit=(cost,currency)=>`${currency==='USD'?'$':'¥'}${num(cost,6)}`;
export function holdingForm(s,editKey='',addTicker='',data={}){
